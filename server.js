...
function rewriteHtml(html, baseUrl) {
  ...
  const adBlockJs = '<script>'
    ...
    + 'gmasdk|gamemonetize[-_]?ad|midroll|pre[-_]?roll|interstitial[-_]?ad/i;'
    ...
    + '\'gtsupport\',\'adsimg\',\'serve.ads\',\'adnxs\',\'casalemedia\',\'pubmatic\','
    + '\'rubiconproject\',\'openx\',\'spotx\',\'taboola\',\'outbrain\',\'revcontent\'];'
    + 'var AD_SCRIPT_PATTERNS=/sdk\\.js|gtag|ga\\.js|analytics|adsbygoogle|adserver|preroll|midroll|showBanner|showInterstitial|showRewarded/i;'
    + 'function isAd(el){'
    ...
    + '    }'
    + '    if(AD_SCRIPT_PATTERNS.test(s))return true;'
    + '  }'
    ...
    + '}'
    + 'function sweep(){'
    + '  var els=document.querySelectorAll(\'script[src],iframe[src],div[id],div[class],span[id],span[class],a[href]\');'
  ...
  // Inject ad-script blocker — intercepts and blocks ad scripts at network level
  const adScriptBlocker = '<script>'
    + '(function(){'
    + 'var BLOCK=/adsbygoogle|googlesyndication|doubleclick|adskeeper|propellerads|'
    + 'monetag|adsterra|adfox|exoclick|gtsupport|casalemedia|pubmatic|rubiconproject|'
    + 'openx|taboola|outbrain|revcontent|criteo|adsafeprotected|imasdk|showBanner|'
    + 'showInterstitial|showRewarded|gmasdk|gamemonetize.*sdk|preroll|midroll/i;'
    + 'var origOpen=XMLHttpRequest.prototype.open;'
    + 'XMLHttpRequest.prototype.open=function(m,u){'
    + '  if(typeof u==="string"&&BLOCK.test(u)){return;}'
    + '  return origOpen.apply(this,arguments);'
    + '};'
    + 'var origFetch=window.fetch;'
    + 'window.fetch=function(r,opts){'
    + '  var url=typeof r==="string"?r:(r&&r.url?"");'
    + '  if(url&&BLOCK.test(url)){return Promise.resolve(new Response("",{status:200}));}'
  ...
  html = html.replace(/<head([^>]*)>/i, '<head$1>' + adScriptBlocker + interceptor + adBlockCss + adBlockJs);
