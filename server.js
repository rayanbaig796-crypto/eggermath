...
function rewriteHtml(html, baseUrl, serverHost, proxyBase) {
  ...
  var adBlockerScript = '<script>'
    ...
    + 'var P=/sdk__implementation|sdk__advertisement|sdk__ad[-_]|imaContainer|ima[-_]video|google[-_]ads|'
    + 'adsbygoogle|google[-_]?ad|yandex[-_]?ad|adbreak|'
    + 'adfox|adskeeper|propellerads|'
    + 'monetag|adsterra|'
    + 'gmasdk|loko|__gads|google_ads|'
    ...
    // ── L14: CSS ad hiders (SDK-specific only — avoids killing game UI) ──
    ...
    + 'return false;}'
    + 'function sweep(){'
    + '  var a=document.querySelectorAll("script[src],iframe[src],ins.adsbygoogle,amp-ad,amp-embed");'
    ...
    + '  var adDivs=document.querySelectorAll("[id*=\\"sdk__\\"],[class*=\\"sdk__\\"],[id*=\\"google_ads\\"],[class*=\\"adsbygoogle\\"],[id*=\\"imaContainer\\"],[class*=\\"loko\\"],[class*=\\"gmasdk\\"],[id*=\\"loko\\"],[id*=\\"gmasdk\\"]");'
    ...
    + 'setInterval(function(){sweep();sweepAllShadows();},2000);'
    + 'setTimeout(function(){sweep();sweepAllShadows();},500);setTimeout(function(){sweep();sweepAllShadows();},1500);'
